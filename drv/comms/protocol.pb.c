...
/* Generated by nanopb-0.3.9.2 at Sun Jan 12 15:50:48 2020. */
...
const pb_field_t Config_fields[10] = {
    ...
    PB_FIELD(  2, MESSAGE , REQUIRED, STATIC  , OTHER, Config, pitch_pid, callibration, &Config_PidConfig_fields),
    PB_FIELD(  3, MESSAGE , REQUIRED, STATIC  , OTHER, Config, foot_pad, pitch_pid, &Config_FootPadSettings_fields),
    ...
    PB_FIELD(  8, MESSAGE , REQUIRED, STATIC  , OTHER, Config, roll_pid, floating, &Config_PidConfig_fields),
    PB_FIELD(  9, MESSAGE , REQUIRED, STATIC  , OTHER, Config, yaw_pid, roll_pid, &Config_PidConfig_fields),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Config, callibration) < 65536 && pb_membersize(Config, pitch_pid) < 65536 && pb_membersize(Config, roll_pid) < 65536 && pb_membersize(Config, yaw_pid) < 65536 && pb_membersize(Config, foot_pad) < 65536 && pb_membersize(Config, balance_settings) < 65536 && pb_membersize(Config, misc) < 65536 && pb_membersize(Config, pushback) < 65536 && pb_membersize(Config, floating) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_Config_Config_Callibration_Config_PidConfig_Config_FootPadSettings_Config_BalancingConfig_Config_PusbackSettings_Config_Misc_Config_FloatSettings_Stats)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Config, callibration) < 256 && pb_membersize(Config, pitch_pid) < 256 && pb_membersize(Config, roll_pid) < 256 && pb_membersize(Config, yaw_pid) < 256 && pb_membersize(Config, foot_pad) < 256 && pb_membersize(Config, balance_settings) < 256 && pb_membersize(Config, misc) < 256 && pb_membersize(Config, pushback) < 256 && pb_membersize(Config, floating) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_Config_Config_Callibration_Config_PidConfig_Config_FootPadSettings_Config_BalancingConfig_Config_PusbackSettings_Config_Misc_Config_FloatSettings_Stats)
#endif
